...
def MACD_main():
    ...
    code = st.sidebar.text_input("请输入股票代码", value="sz.399001")
    start_date = st.sidebar.text_input("请输入开始日期", value="2022-01-01")
    end_date = st.sidebar.text_input("请输入结束日期", value="2024-01-01")
