...
def show_data_from_df(
    ...
    return {
        ...
        "difs": df_or_dfpath["DIFF"].tolist()  if "DIFF" in df_or_dfpath else [],
        "deas": df_or_dfpath["DEA"].tolist() if "DEA" in df_or_dfpath else [],
        "buy": buy_list,
        "sell": sell_list,
    }
...
if __name__ == "__main__":
    csv_path = "Data/RealData/hfq/600570.csv"
